...
import static com.blogsystem.cache.CacheConstant.REFILL_CAPACITY;
...
public class RateLimitFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(@NonNull HttpServletRequest request,
    ...
    if (Boolean.FALSE.equals(unsecuredApiBeingInvoked) && authentication != null) {
      ...
      if (bucket == null) {
        cacheUtil.saveBucket(username, CacheConstant.REFILL_CAPACITY);
        response.setHeader("X-Rate-Limit-Remaining", String.valueOf(CacheConstant.REFILL_CAPACITY));
